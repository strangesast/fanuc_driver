...
with open("../streams/src/main/avro/AdapterDatumSer.avsc", "rb") as f:
    schema = avro.schema.parse(f.read())
    reader = avro.io.DatumReader(schema)

consumer = KafkaConsumer('execution', bootstrap_servers=bootstrap_servers, auto_offset_reset='earliest')
for msg in consumer:
